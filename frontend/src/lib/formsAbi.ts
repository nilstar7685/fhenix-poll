// FhenixForms contract ABI + address

export const FORMS_CONTRACT_ADDRESS: `0x${string}` =
  (import.meta.env.VITE_FORMS_CONTRACT_ADDRESS as `0x${string}`) ??
  '0x1796944Ac448714897B113B5FB2cD6D79b6a5B9d'

export const FHENIX_FORMS_ABI = [
  {
    type: 'function', name: 'createForm',
    inputs: [
      { name: 'formId',         type: 'bytes32'   },
      { name: 'metadataHash',   type: 'bytes32'   },
      { name: 'durationBlocks', type: 'uint32'    },
      { name: 'questionCount',  type: 'uint8'     },
      { name: 'qTypes',         type: 'uint8[]'   },
      { name: 'slotCounts',     type: 'uint8[]'   },
  ...
  {
    type: 'function', name: 'submitResponse',
    inputs: [
      { name: 'formId',     type: 'bytes32' },
  ...
  {
    type: 'function', name: 'hasResponded',
    inputs: [
      { name: 'formId', type: 'bytes32' },
  ...
  { type: 'event', name: 'ResponseSubmitted', inputs: [
    { name: 'formId', type: 'bytes32', indexed: true },
